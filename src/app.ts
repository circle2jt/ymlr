...
export class App {
  ...
  constructor(public logger: Logger, rootSceneProps: RootSceneProps) {
    ...
    const rootScene = new RootScene(rootSceneProps)
    this.#rootSceneProxy = new ElementProxy(rootScene)
    // this.#rootSceneProxy.scene = this.#rootSceneProxy.rootScene = rootScene
