...
export class ConsoleLogger extends Logger {
  ...
  getPrefixMsg(level: any) {
    return `${App.ThreadID} [${UtilityFunctionManager.Instance.format.date(new Date(), 'hh:mm:ss.ms')}] ${GetLoggerLevelName(level)} ${this.indent.indentString}%s \t ${chalk.gray(this.context)}`
